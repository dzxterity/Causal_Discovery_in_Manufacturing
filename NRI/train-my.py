...
parser.add_argument('--epochs', type=int, default=100, #было 500 эпох
...
parser.add_argument('--num-atoms', type=int, default=52,
...
parser.add_argument('--load-folder', type=str, default='', #logs/exp2023-07-26T16:27:04.767683
